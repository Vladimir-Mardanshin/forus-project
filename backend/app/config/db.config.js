var dbProperties = {
    database: 'forus', // название базы данных
...
db.space = require('../model/space.model.js')(sequelize, Sequelize);
db.user_img = require('../model/user_img.model.js')(sequelize, Sequelize);
